    ...
    <Section id="equipo" eyebrow="Los rostros del canal" title="Conoce al equipo" background="#fff">
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 18 }}>
        {LZM_DATA.hosts.map((h) => (
          <div key={h.id} className="lzm-card lzm-pop">
            <div style={{ aspectRatio: '1 / 1', background: h.bg, borderBottom: '3px solid #111', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div style={{ fontFamily: "'Black Ops One'", fontSize: 90, color: '#fff', WebkitTextStroke: '3px #111', textShadow: '4px 4px 0 #111', lineHeight: 1, filter: h.bg === '#FDD835' ? 'invert(1)' : 'none' }}>
                {h.initials}
              </div>
            ...
            <div style={{ padding: 14 }}>
              ...
              <a href={`https://instagram.com/${h.ig}`} target="_blank" rel="noreferrer"
